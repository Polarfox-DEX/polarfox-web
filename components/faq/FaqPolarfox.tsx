  ...
  return (
    <div className={classNames('divide-y divide-gray-light w-full', className)}>
      <Question question="What is Polarfox Labs?" isOpenDefault>
        ...
        enthusiasts who chose to build a great financial{' '}
        <span className="font-bold">ecosystem</span> for its users. Currently we
        are building the path to a robust financial ecosystem.
        <br />
        <br />
      ...
      <Question question="What is the Polarfox ecosystem?">
        ...
        has the vocation of becoming much more, thus forming a decentralized{' '}
        <span className="font-bold">ecosystem of applications</span> whose goals
        are to:
        <ul
          className="list-disc list-inside pl-4"
          style={{ fontSize: calcRem(15), lineHeight: calcRem(25) }}
      ...
      <Question question="What apps will be in the Polarfox ecosystem?">
        The AKITA Network is going to be one of the main applications of that
        ecosystem and receive funding from Polarfox. Some of the applications
        that could be added to the ecosystem include multi-signature wallets,
        payment processors, bridges to other blockchains, websites that will
        actively advertise Avalanche, among others.
        <br />
        <br />
        Another goal of the ecosystem is to help potential partners to create
        and develop technology on Avalanche and provide support and resources to
        their projects.
      </Question>
      <Question question="What blockchain(s) will the Polarfox ecosystem support?">
        The core of Polarfox is and will stay on{' '}
        <span className="font-bold">Avalanche</span>, while cross-chain features
        and applications on other blockchains are incorporated into it — the
        Dreamswap exchange on Polygon is one example of that.
      </Question>
      <Question question="What are the team’s financial resources?">
        The team has not had any funding since February. Through the launch of
        the Polarfox DEX, we will introduce our own funding with:
        <ul
          className="list-disc list-inside pl-4"
          style={{ fontSize: calcRem(15), lineHeight: calcRem(25) }}
        >
