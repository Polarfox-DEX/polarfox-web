  ...
  return (
    <div className={classNames('divide-y divide-gray-light w-full', className)}>
      ...
      <Question question="What is AKITA Network?">
        ...
        This project is determined to start in 2022. The AKITA token will be the
        token used to interact within the social platform.
        <br />
        <br />
      ...
      <Question question="What is gAKITA?">
        gAKITA will be the governance token of the AKITA Network. It will only
        be minted during a 60-day period on Polarfox by staking AKITA with PFX
        or AVAX.
        <br />
        <br />
        There will also be a liquidity mining pool on the Polarfox DEX to earn
        PFX by staking gAKITA with AVAX in the future.
      </Question>
    </div>
  )
}
